...
def extract_frames_with_lookahead(video_path, output_dir, num_samples=5):
    # 确保输出目录存在
    ...
    # 释放视频对象
    cap.release()
    print(f"Extracted {extracted_count} frames (in {num_samples} groups) from {video_path} to {output_dir}")
...
if __name__ == "__main__":
    ...
    extract_frames_with_lookahead(video_path, output_dir, num_samples=5)